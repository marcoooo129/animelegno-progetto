...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen text-[#44403C] selection:bg-[#D7CCC8] selection:text-[#3E2723] cursor-auto md:cursor-none overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-12 py-6 bg-[#FAFAF9]/80 backdrop-blur-md border-b border-[#E7E5E4]">
        <div className="font-heading text-xl md:text-2xl font-bold tracking-tight text-[#3E2723] cursor-default z-50 flex items-center gap-2">
          AnimeLegno Studio
        </div>
          ...
          >
            {['Portfolio', 'Custom', 'Contact'].map((item) => (
              <button
                key={item}
                onClick={() => scrollToSection(item.toLowerCase())}
                className="text-4xl font-heading font-bold text-[#3E2723] hover:text-[#8D6E63] transition-colors uppercase bg-transparent border-none"
              >
                {item}
              </button>
            ))}
            ...
            <button 
              ...
              className="flex items-center gap-2 text-sm font-bold text-[#8D6E63] uppercase tracking-widest"
            >
      ...
      <header className="relative h-[100svh] min-h-[600px] flex flex-col items-center justify-center overflow-hidden px-4">
        ...
        >
          ...
          <motion.div
            ...
            className="flex items-center gap-3 md:gap-4 text-xs md:text-sm font-medium text-[#5D4037] tracking-[0.2em] uppercase mb-6 bg-white/50 px-6 py-2 rounded-full backdrop-blur-sm border border-[#D7CCC8]"
          >
          ...
          <div className="relative w-full flex justify-center items-center flex-col pb-4">
            <h1 className="text-[12vw] md:text-[8vw] leading-[1.2] font-bold tracking-tight text-center text-[#3E2723] p-2">
              <GradientText text="AnimeLegno" />
            </h1>
            <p className="text-xl md:text-3xl font-serif italic text-[#5D4037] mt-2 md:mt-4">
          ...
          <motion.div
             ...
             className="w-24 h-1 bg-[#8D6E63] mt-4 mb-8 rounded-full"
          />
          ...
          <motion.p
            ...
            className="text-base md:text-xl font-light max-w-xl mx-auto text-[#44403C] leading-relaxed px-4"
          >
          ...
          <motion.button
             ...
             className="mt-10 px-8 py-3 bg-[#3E2723] text-white rounded-full font-medium tracking-wide hover:bg-[#5D4037] transition-colors shadow-lg shadow-[#3E2723]/20"
             data-hover="true"
          >
            Explore Collection
          </motion.button>
      ...
      <section id="portfolio" className="relative z-10 py-20 md:py-32">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center mb-16 px-4 text-center">
             <h2 className="text-4xl md:text-6xl font-heading font-bold text-[#3E2723] mb-4">
              Our <span className="text-[#8D6E63]">Masterpieces</span>
            </h2>
            <p className="text-[#5D4037] max-w-2xl">
      ...
      <section id="custom" className="relative z-10 py-20 md:py-32 bg-[#EFEBE9] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-[#3E2723] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                key={i}
                whileHover={{ y: -10 }}
                className="bg-[#FAFAF9] p-8 rounded-2xl shadow-sm border border-[#D7CCC8] flex flex-col items-center text-center"
              >
                <div className="w-16 h-16 bg-[#F5F5DC] rounded-full flex items-center justify-center mb-6 text-[#8D6E63]">
          ...
          <div className="mt-16 bg-[#3E2723] text-[#F5F5DC] p-6 md:p-8 rounded-2xl max-w-3xl mx-auto text-center shadow-xl transform rotate-1">
      ...
      <section id="contact" className="relative z-10 py-20 md:py-32 px-4 md:px-6 bg-[#FAFAF9]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
             <h2 className="text-4xl md:text-6xl font-heading font-bold text-[#3E2723]">
               GET IN TOUCH
             </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a 
              ...
              className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg border border-[#E7E5E4] flex flex-col items-center transition-all duration-300"
              data-hover="true"
            >
              <div className="bg-gradient-to-tr from-purple-500 to-orange-500 text-white p-4 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <Instagram className="w-8 h-8" />
              </div>
              <h3 className="font-bold text-lg text-[#3E2723]">Instagram</h3>
              <p className="text-sm text-[#8D6E63] mt-2">@animelegno_firenze</p>
              <span className="mt-6 text-xs uppercase tracking-widest border-b border-[#3E2723] pb-1">Follow Us</span>
            </a>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg border border-[#E7E5E4] flex flex-col items-center transition-all duration-300 transform md:-translate-y-4"
              data-hover="true"
            >
              <div className="bg-green-500 text-white p-4 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <MessageCircle className="w-8 h-8" />
              </div>
              <h3 className="font-bold text-lg text-[#3E2723]">WhatsApp</h3>
              <p className="text-sm text-[#8D6E63] mt-2">Chat Directly</p>
              <span className="mt-6 text-xs uppercase tracking-widest border-b border-[#3E2723] pb-1">Start Chat</span>
            </a>
            ...
            <a 
              ...
              data-hover="true"
            >
              <div className="bg-[#3E2723] text-white p-4 rounded-full mb-4 group-hover:scale-110 transition-transform">
                <Mail className="w-8 h-8" />
              </div>
              <h3 className="font-bold text-lg text-[#3E2723]">Email</h3>
              <p className="text-sm text-[#8D6E63] mt-2">hello@animelegno.com</p>
              <span className="mt-6 text-xs uppercase tracking-widest border-b border-[#3E2723] pb-1">Send Mail</span>
            </a>
          </div>
        </div>
      </section>

      <footer className="relative z-10 border-t border-[#E7E5E4] py-12 bg-[#F5F5F4]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
             <div className="font-heading text-2xl font-bold tracking-tight text-[#3E2723]">AnimeLegno Studio</div>
      ...
      <AnimatePresence>
        {selectedProduct && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-[#3E2723]/60 backdrop-blur-sm cursor-auto"
          >
            <motion.div
              ...
              className="relative w-full max-w-5xl bg-[#FAFAF9] rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl shadow-black/20"
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedProduct(null)}
                className="absolute top-4 right-4 z-20 p-2 rounded-full bg-white/80 text-[#3E2723] hover:bg-[#3E2723] hover:text-white transition-colors shadow-sm"
                data-hover="true"
              >
                <X className="w-6 h-6" />
              </button>
              ...
              <button
                ...
                className="absolute left-4 bottom-4 translate-y-0 md:top-1/2 md:bottom-auto md:-translate-y-1/2 z-20 p-3 rounded-full bg-white/80 text-[#3E2723] hover:bg-[#3E2723] hover:text-white transition-colors shadow-md"
                data-hover="true"
              >
              ...
              <button
                ...
                className="absolute right-4 bottom-4 translate-y-0 md:top-1/2 md:bottom-auto md:-translate-y-1/2 z-20 p-3 rounded-full bg-white/80 text-[#3E2723] hover:bg-[#3E2723] hover:text-white transition-colors shadow-md md:right-8"
                data-hover="true"
              >
              ...
              {/* Image Side */}
              <div className="w-full md:w-1/2 h-64 md:h-auto relative overflow-hidden bg-[#EFEBE9]">
              ...
              {/* Content Side */}
              <div className="w-full md:w-1/2 p-8 pb-24 md:p-12 flex flex-col justify-center relative bg-[#FAFAF9]">
                <motion.div
                  key={selectedProduct.id}
                ...
                >
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full font-bold hover:bg-[#128C7E] transition-colors w-full md:w-auto"
                  >
